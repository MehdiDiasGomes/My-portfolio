<template>
    <div class="flex flex-col gap-5 w-full">
        ...
        <div>
            <input type="text" placeholder="votre@mail.com"
                class="w-full h-12 p-3 border text-white border-[#E5484D] bg-[#1E1E1E] rounded-xl focus:outline-none focus:border-[#E5484D] focus:ring-2 focus:ring-[#E5484D]">
        </div>
        <div>
            <textarea name="textarea" id="textarea" placeholder="Votre message"
                class="resize-y w-full h-64 p-3 border text-white border-[#E5484D] bg-[#1E1E1E] rounded-xl focus:outline-none focus:border-[#E5484D] focus:ring-2 focus:ring-[#E5484D]"></textarea>
        </div>
        <button
            ...
            <span class="relative z-10">Envoyer message</span>
            <div
