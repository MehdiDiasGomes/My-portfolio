        ...
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                <RouterLink to="/" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                    <img src="/img/Logo.png" class="h-8" alt="Mehdi Logo" />
                </RouterLink>
                <ul class="flex flex-wrap items-center gap-4 text-white mb-6 text-sm font-medium">
                    <li>
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">©
                2024 Mehdi DIAS GOMES™. All Rights Reserved.</span>
        </div>
    </footer>
</template>
<script setup>
